...
\frametitle{Permutation tests}
\begin{itemize}
\item Randomization inference doesn't require distributional assumptions about $\eps_i$ or $Y_i$.
\item Stratification allows effects to vary (in magnitude, in sign, etc.) across strata.
\end{itemize}
}
